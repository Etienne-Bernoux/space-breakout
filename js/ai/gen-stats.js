...
const HEADER = ['Gen', 'Best', 'Avg', 'Catch', 'Destr', 'Rally', 'Drops', 'Track', 'Caps', 'Wins'];
const WIDTHS = [5,     7,      7,     6,       6,       6,       6,       6,       5,      5];
 ...
 * @returns {object} { gen, bestFitness, avg, catches, destroys, rallyScore, drops, tracking, capsules, winCount }
 */
...
export function formatGenStats(s) {
  return [
    ...
    String(s.tracking + '%').padStart(WIDTHS[7]),
    String(s.capsules).padStart(WIDTHS[8]),
