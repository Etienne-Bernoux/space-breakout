...
export const ZONE_1 = {
  ...
  levels: [
    ...
    { id: 'z1-3', name: 'Ceinture dense',  asteroids: { rows: 10, cols: 14, materials: { rock: 0.85, metal: 0.15 }, pattern: PATTERNS.diamond },  timeTarget: 110 },
    { id: 'z1-4', name: 'Corridor étroit',  asteroids: { rows: 10, cols: 14, materials: { rock: 0.8, metal: 0.2 }, pattern: PATTERNS.corridors },  timeTarget: 115 },
    { id: 'z1-5', name: 'Noyau rocheux',   asteroids: { rows: 10, cols: 14, materials: { rock: 0.75, metal: 0.25 }, pattern: PATTERNS.tunnel },   timeTarget: 130 },
